...
module.exports = {
  conf: {
    ...
    google: {
      ...
      client_secret: process.env.PROD_google_api_key,
      api_key: process.env.PROD_google_api_key
    },
    apple: {
      client_id: process.env.PROD_apple_client_id,
      host_client_id: process.env.PROD_apple_host_client_id
    },
    aws: {
    ...
    expo: {
      access_token: process.env.PROD_expo_access_token
    },
